              ...
              {filtered.map((c) => {
                ...
                if (isAvail) {
                  return (
                    ...
                    >
                      ...
                      <h3 className='font-bold text-[#15201f] text-[16px] mb-1 line-clamp-1'>
                        {c.name}
                      </h3>
                      <div className='text-[13px] text-[#6b7b79] mb-3'>{c.loaded} hosts listed</div>
                      <div>
                        <span className='text-[10px] font-bold text-[#1e9e72] border border-[#1e9e72] px-2 py-0.5 rounded-full uppercase tracking-wider inline-block bg-[#f0fdf4]'>
                          Available
                        </span>
                      </div>
                    </Link>
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <span className='text-[10px] font-bold text-[#6b7b79] border border-[#e7e1d6] px-2 py-0.5 rounded-full uppercase tracking-wider inline-block bg-[#f8fafc]'>
                        Coming soon
                      </span>
                    </div>
                  </div>
