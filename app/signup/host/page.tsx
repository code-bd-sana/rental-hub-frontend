        ...
        <div className='bg-white p-6 md:p-8 shadow-[0_10px_30px_rgba(11,79,74,0.1)] rounded-[18px]'>
          ...
          {step === 1 && (
            <form onSubmit={handleNextStep1} className='animate-in fade-in duration-300'>
              ...
              <button
                type='submit'
                className='w-full mt-6 bg-[#2563eb] text-white rounded-[30px] py-3.5 px-6 font-bold text-[16px] hover:bg-[#1e40af] transition-colors shadow-sm'
              >
          ...
          {step === 2 && (
            ...
            >
              <button
                type='button'
                onClick={() => setStep(1)}
                className='text-[#6b7b79] hover:text-[#15201f] text-sm mb-4 font-semibold flex items-center transition-colors'
              >
                &larr; Back
              </button>
              <h2
              ...
              <p className='text-[#6b7b79] text-[14px] mb-6'>
                Tell us a little bit about what you host. (All fields are optional for now, you can
                complete them later).
              </p>

              <div className='space-y-5'>
                <div>
                  <label className='block text-[13px] font-bold text-[#15201f] mb-2.5'>
                  ...
                  <div className='flex flex-wrap gap-2'>
                    {availableHostTypes.map((t) => (
                      <button
                        type='button'
                        key={t.value}
                        onClick={() => toggleHostType(t.value)}
                        className={`border rounded-[22px] px-4 py-2 text-[13px] font-semibold transition-colors ${hostTypes.includes(t.value) ? 'bg-[#1e40af] text-white border-[#1e40af]' : 'border-[#e7e1d6] bg-[#f8fafc] text-[#15201f] hover:bg-[#dbeafe]'}`}
                      >
                        {t.label}
                      </button>
                    ))}
                ...
                <div>
                  ...
                  <input
                    ...
                    type='text'
                    placeholder='e.g. Oceanview Rentals LLC'
                    className='appearance-none block w-full px-4 py-3 border border-[#e7e1d6] rounded-xl bg-[#f8fafc] text-[15px] focus:outline-none focus:ring-2 focus:ring-[#2563eb] focus:border-transparent placeholder-[#6b7b79]'
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    type='text'
                    placeholder='123 Coastal Highway, Suite 100'
                    className='appearance-none block w-full px-4 py-3 border border-[#e7e1d6] rounded-xl bg-[#f8fafc] text-[15px] focus:outline-none focus:ring-2 focus:ring-[#2563eb] focus:border-transparent placeholder-[#6b7b79]'
                  />
                </div>
              </div>
              ...
              <button
                type='submit'
                className='w-full mt-8 bg-[#2563eb] text-white rounded-[30px] py-3.5 px-6 font-bold text-[16px] hover:bg-[#1e40af] transition-colors shadow-sm'
              >
          ...
          {step === 3 && (
            ...
            >
              ...
              <p className='text-[#6b7b79] text-[14px] mb-6'>
                Upload your ID or business registration documents to expedite your approval.
                (Optional for now)
              </p>
              ...
              <div className='border-2 border-dashed border-[#e7e1d6] rounded-xl p-8 text-center bg-[#f8fafc] mb-6 relative hover:border-[#2563eb] transition-colors group'>
                ...
                <div className='flex flex-col items-center justify-center space-y-3 pointer-events-none'>
                  ...
                  <div>
                    <span className='text-[#2563eb] font-semibold'>Click to upload</span> or drag
                    and drop
              ...
              {documents.length > 0 && (
                <div className='space-y-2 mb-6'>
                  ...
                  {documents.map((file, i) => (
                    <div
                      key={i}
                      className='flex items-center justify-between bg-white border border-[#e7e1d6] p-3 rounded-xl shadow-sm'
                    >
                      <div className='flex items-center overflow-hidden'>
                        <svg
                          xmlns='http://www.w3.org/2000/svg'
                          className='h-5 w-5 text-[#6b7b79] mr-2 shrink-0'
                          fill='none'
                          viewBox='0 0 24 24'
                          stroke='currentColor'
                        >
                        ...
                        <span className='text-sm font-medium text-[#15201f] truncate'>
                          {file.name}
                        </span>
                      </div>
                      <button
                        ...
                        className='text-red-500 hover:text-red-700 hover:bg-red-50 p-1.5 rounded-lg transition-colors ml-2 shrink-0'
                      >
                        <svg
                          xmlns='http://www.w3.org/2000/svg'
                          className='h-4 w-4'
              ...
              <button
                type='submit'
                disabled={loading}
                className='w-full mt-4 bg-[#2563eb] text-white rounded-[30px] py-3.5 px-6 font-bold text-[16px] hover:bg-[#1e40af] transition-colors shadow-sm disabled:opacity-50'
              >
          ...
          {step === 4 && (
            <div className='text-center animate-in zoom-in-95 duration-500 py-6'>
              ...
              <p className='text-[#6b7b79] text-[15px] mb-8 leading-relaxed'>
                ...
                <span className='font-bold text-amber-600'>Pending Approval</span>. We will review
                your details and documents shortly.
              </p>
