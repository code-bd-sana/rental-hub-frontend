...
export function AdminOverview() {
  return (
    <div className='animate-in fade-in duration-300'>
      ...
      <p className='text-[14px] text-[#6b7b79] mb-4.5'>Load progress and revenue at a glance.</p>
          ...
          <tbody>
            <tr>
              ...
              <td className='p-[12px_16px] border-b border-[#e7e1d6] w-40'>
                <div className='bg-[#e7e1d6] h-1.5 rounded-sm overflow-hidden'>
                  <div className='bg-[#1e9e72] h-full' style={{ width: '8%' }}></div>
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td className='p-[12px_16px] w-40'>
                <div className='bg-[#e7e1d6] h-1.5 rounded-sm overflow-hidden'>
                  <div className='bg-[#1e9e72] h-full' style={{ width: '3.3%' }}></div>
                </div>
              </td>
            </tr>
          </tbody>
          ...
          <tbody>
            <tr>
              ...
              <td className='p-[12px_16px] border-b border-[#e7e1d6] text-right space-x-2'>
                <button className='border border-[#2563eb] bg-[#2563eb] text-white rounded-[9px] px-2.75 py-1.5 text-[12px] font-semibold hover:bg-[#1e40af]'>
                  Approve
                </button>
                <button className='border border-[#e7e1d6] bg-white text-[#172554] rounded-[9px] px-2.75 py-1.5 text-[12px] font-semibold hover:bg-[#f8fafc]'>
                  Reject
                </button>
              </td>
            </tr>
            ...
            {isLoading ? (
              ...
              listings.map((lst) => (
                <tr key={lst.id} className='hover:bg-[#f8fafc] transition-colors'>
                  <td className='p-[12px_16px] border-b border-[#e7e1d6] text-[#15201f] font-semibold'>
                    {lst.title}
                  </td>
      ...
      <div className='bg-white border border-[#e7e1d6] rounded-2xl shadow-[0_10px_30px_rgba(11,79,74,0.1)] overflow-hidden mt-4'>
        <div className='flex justify-between items-center px-4 py-3.5 border-b border-[#e7e1d6]'>
          ...
          <button
            ...
            className='border border-[#2563eb] bg-[#2563eb] text-white rounded-[9px] px-2.75 py-1.5 text-[12px] font-semibold transition-colors hover:bg-[#1e40af] cursor-pointer'
          >
            Add new country
          </button>
        </div>
        <table className='w-full border-collapse text-[14px]'>
          ...
          <tbody>
            {isLoading ? (
              ...
              countries.map((c) => {
                const progress =
                  c.target > 0 ? Math.min(100, Math.round((c.loaded / c.target) * 100)) : 0;
                return (
                    ...
                    <td className='p-[12px_16px] border-b border-[#e7e1d6] w-40'>
                      <div className='flex items-center gap-2'>
                        <div className='bg-[#e7e1d6] h-1.5 rounded-sm overflow-hidden flex-1'>
                          <div
                            className='bg-[#1e9e72] h-full'
                            style={{ width: `${progress}%` }}
                          ></div>
                        </div>
                        <span className='text-[11px] font-bold text-[#6b7b79] w-8 text-right'>
                          {progress}%
                        </span>
                      </div>
                    </td>
          ...
          <div className='bg-white rounded-2xl max-w-100 w-full shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden animate-in zoom-in-95 duration-200'>
            <form onSubmit={handleSubmit}>
              ...
              <div className='p-6 space-y-4'>
                <div>
                  <label className='block text-[13px] font-semibold text-[#15201f] mb-1.5'>
                    Country Name
                  </label>
                  <input
                    type='text'
              ...
              <div className='p-4 border-t border-[#e7e1d6] flex justify-end gap-3 bg-[#f8fafc]'>
                ...
                <button
                  type='submit'
                  disabled={isSubmitting}
                  className='px-4 py-2 text-[14px] font-semibold bg-[#2563eb] text-white hover:bg-[#1e40af] rounded-xl transition-colors cursor-pointer disabled:opacity-50 flex items-center justify-center min-w-17.5'
                >
        ...
        <div className='fixed inset-0 bg-[rgba(21,32,31,0.5)] z-100 flex items-center justify-center p-4 backdrop-blur-sm'>
          <div className='bg-white rounded-2xl max-w-100 w-full shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden animate-in zoom-in-95 duration-200'>
            <div className='p-6'>
              ...
              <p className='text-[14px] text-[#6b7b79]'>
                Are you sure you want to delete this country? This will not delete the associated
                listings, but the country goal will be removed.
              </p>
            </div>
            <div className='p-4 border-t border-[#e7e1d6] flex justify-end gap-3 bg-[#f8fafc]'>
              <button
              ...
              <button
                onClick={confirmDelete}
                disabled={isSubmitting}
                className='px-4 py-2 text-[14px] font-semibold bg-[#ef4444] text-white hover:bg-[#dc2626] rounded-xl transition-colors cursor-pointer disabled:opacity-50 flex items-center justify-center min-w-17.5'
              >
...
export function AdminGuests() {
  return (
    <div className='animate-in fade-in duration-300'>
      ...
      <p className='text-[14px] text-[#6b7b79] mb-4.5'>Guest accounts and subscription status.</p>
...
export default function AdminDashboard() {
  ...
  return (
    <div className='flex h-screen bg-[#f8fafc] font-sans'>
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-[#15201f] text-white transition-transform duration-300 ease-in-out md:static md:translate-x-0 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}
      >
        <div className='flex flex-col h-full'>
          <div className='p-6'>
            ...
            <p className='text-[#6b7b79] text-[10px] tracking-[1px] uppercase mt-1'>
      ...
      <main className='flex-1 overflow-y-auto'>
        <div className='md:hidden p-4 bg-white border-b border-[#e7e1d6] flex justify-between items-center sticky top-0 z-30'>
          ...
          <button
            ...
            className='p-2 text-[#15201f] hover:bg-[#f8fafc] rounded-lg'
          >
            ☰
          </button>
        </div>
      ...
      {isMobileMenuOpen && (
        <div
          className='fixed inset-0 bg-[#15201f]/20 z-30 md:hidden backdrop-blur-sm'
